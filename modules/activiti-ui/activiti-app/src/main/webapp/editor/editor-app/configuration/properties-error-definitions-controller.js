...
angular.module('activitiModeler').controller('ActivitiErrorDefinitionsCtrl', ['$scope', '$modal', function ($scope, $modal) {
...
angular.module('activitiModeler').controller('ActivitiErrorDefinitionsPopupCtrl',
    ['$scope', '$q', '$translate', '$timeout', function ($scope, $q, $translate, $timeout) {

        // Put json representing error definitions on scope
        ...
        // Array to contain selected error definitions (yes - we only can select one, but ng-grid isn't smart enough)
        ...
        var namePromise = $translate('PROPERTY.ERRORDEFINITIONS.NAME');
        var scopePromise = $translate('PROPERTY.ERRORDEFINITIONS.SCOPE');
        ...
        $scope.addNewErrorDefinition = function () {
            var newErrorDefinition = {id: '', name: '', scope: 'global'};
        ...
        $scope.scopeOptions = [{'value': 'global', 'translationId': 'PROPERTY.ERRORDEFINITIONS.SCOPE-GLOBAL'},
                                {'value': 'processInstance', 'translationId': 'PROPERTY.ERRORDEFINITIONS.SCOPE-PROCESSINSTANCE'}];
