...
angular.module('activitiModeler').controller('ActivitiErrorRefCtrl', [ '$scope', function($scope) {
    ...
    while (parent !== null && parent !== undefined && errorDefinitionsProperty === undefined) {
        if (parent.properties && parent.properties['oryx-errordefinitions']) {
            errorDefinitionsProperty = parent.properties['oryx-errordefinitions'];
        } else {
